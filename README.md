...
| `VISION_MODEL` | ❌ | `doubao-seed-2-0-lite-260428` | 火山引擎 ARK 模型 ID。在[模型详情页](https://console.volcengine.com/ark/region:ark+cn-beijing/model/detail?Id=doubao-seed-2-0-lite)找到 **Model ID** 字段，点击复制按钮获取 |
